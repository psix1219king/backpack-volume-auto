...
DELAY_BETWEEN_TRADE = (5, 30)  # Execute delay between every trade (Buy -> Delay -> Sell -> Buy -> Delay ...)
DELAY_BETWEEN_DEAL = (40, 120)  # Execute delay between full trade (Buy -> Sell -> Delay -> Buy -> Sell -> Delay ...)
...
ALLOWED_ASSETS = ["SOL_USDC", "WIF_USDC", "WEN_USDC"]
